...
module.exports = function (nodecg) {
    ...
    twitchApi === null || twitchApi === void 0 ? void 0 : twitchApi.onUnavailable(() => {
        nodecg.log.info("twitch-api has been unset.");
    });
    const registered = [];
    twitchChat === null || twitchChat === void 0 ? void 0 : twitchChat.onAvailable(
    ...
    twitchChat === null || twitchChat === void 0 ? void 0 : twitchChat.onUnavailable(() => nodecg.log.info("Twitch chat client has been unset."));
};
/**
 *
 *
