  ...
  const handleChange = (event: FormEvent<HTMLInputElement>) => {
    setTestData({
      ...
      [event.currentTarget.name]:
        event.currentTarget.type === "number" ? Number.parseInt(event.currentTarget.value) : event.currentTarget.value,
    })
  }
    ...
    <>
      <div className="test-section">
        <div className="test-header">
          <div className="test-header-title">Test Bits</div>
          <div className="test-header-buttons">
            <div onClick={handleShowBody}>
              <DownChevronIcon />
            </div>
          </div>
        </div>
        {showBody && (
          <div className="test-body">
            ...
            <input id="bits-used" name="bits_used" value={testData.bits_used} type="number" onChange={handleChange} />
            <label htmlFor="chat-message">Chat Message</label>
            <input id="chat-message" name="chat_message" value={testData.chat_message} onChange={handleChange} />
            <button className="twitch" onClick={handleSendMessage}>
              Send
            </button>
          </div>
        )}
...
function TestRedemption() {
  ...
  return (
    <>
      <div className="test-section">
        <div className="test-header">
          <div className="test-header-title">Test Channel Points</div>
          <div className="test-header-buttons">
            <div onClick={handleShowBody}>
              <DownChevronIcon />
            </div>
        ...
        {showBody && (
          <div className="test-body">
            ...
            <input
              id="user-name"
              name="user_name"
              value={testData.redemption.user.display_name}
              onChange={handleChangeUserName}
            />
            <label htmlFor="redemption-reward-title">Title</label>
            <input
              id="redemption-reward-title"
              name="redemption.reward.title"
              value={testData.redemption.reward.title}
              onChange={handleChangeTitle}
            />
            <label htmlFor="redemption-reward-cost">Cost</label>
            <input
              id="redemption-reward-cost"
              name="redemption.reward.cost"
            ...
            <input
              id="user-input"
              name="redemption.user_input"
              value={testData.redemption.user_input}
