...
module.bundle.HMR_BUNDLE_ID = "b341779959a9a5eb";
"use strict";
...
},{}],"6q4Sg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
var position = nodecg.Replicant("posLogo");
_jqueryDefault.default("#refreshBtn").on("click", ()=>nodecg.sendMessage("refreshClient")
);
var selectPos = _jqueryDefault.default("select[name='position']").length > 0 ? _jqueryDefault.default("select[name='position']") : _jqueryDefault.default(`<select name='position'>
...
NodeCG.waitForReplicants(position).then(()=>{
    selectPos.on("change", (e)=>{
        let selected = _jqueryDefault.default(e.target).find("option:selected").val();
        let final = [
            0,
            0
        ];
