...
module.bundle.HMR_BUNDLE_ID = "610662346a1fea13";
"use strict";
...
},{}],"91F7W":[function(require,module,exports) {
...
var position = nodecg.Replicant("posLogo");
var posMap = {
    "Starting/Ending": {
...
var logo = _jqueryDefault.default("#logo").length > 0 ? _jqueryDefault.default("#logo") : _jqueryDefault.default("<video id='logo'/>");
logo.attr("loop", "loop").attr("autoplay", "autoplay").attr("muted", "muted").attr("playsinline", "playsinline").attr("preload", "auto").appendTo("body");
const onScene = (newVal)=>{
    let css = posMap[newVal] || posMap.default;
    _gsapDefault.default.set(logo, {
        autoAlpha: 1
    });
    _gsapDefault.default.to(logo, {
        ...css,
        duration: 0.5,
        ease: "power2.out"
    });
...
NodeCG.waitForReplicants(LogoSrc, currScene, position).then(function() {
    ...
    onScene(currScene.value);
    position.on("change", (newVal)=>{
        posMap.default.x = (newVal[1] == 1 ? window.innerWidth - (logo.innerWidth() || 0) : newVal[1] == 0.5 ? window.innerWidth / 2 - (logo.innerWidth() || 0) / 2 : 24) + -20;
