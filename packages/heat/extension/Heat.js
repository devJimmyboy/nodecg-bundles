...
const fetch = (...args) => 
// @ts-ignore
Promise.resolve().then(() => import("node-fetch")).then(({ default: fetch }) => fetch(...args));
class Heat extends events_1.EventEmitter {
    ...
    async getUserById(id) {
        ...
        if (id.startsWith("U"))
            return { display_name: "Unverified" };
    ...
    async getToken() {
        ...
        if (((_a = this.token.value) === null || _a === void 0 ? void 0 : _a.refresh_token) &&
