...
})({"44WKw":[function(require,module,exports) {
...
},{"react-refresh/runtime":"ckg0X"}],"ckg0X":[function(require,module,exports) {
'use strict';
module.exports = require('./cjs/react-refresh-runtime.development.js');

},{"./cjs/react-refresh-runtime.development.js":"bXwoC"}],"bXwoC":[function(require,module,exports) {
...
},{}],"2rPnn":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
...
function sortGoals(goals) {
    ...
    while(goalQueue.length > 0 && goalQueue[0].goal < currentSubs.value)doneGoals.unshift(goalQueue.shift());
    currentGoal = goalQueue[0];
...
function displayGoals() {
    goalQueue.forEach(function(goal, i) {
        if (i == 0) {
            ...
            goalSubs.text(currentSubs.value).css({
                left: goalProgress.outerWidth() - goalSubs.outerWidth() / 2,
                top: goalProgress.height()
            });
            goalName.text(goal.reward);
            goalGoal.text(goal.goal);
        } else {
            let futGoal = _jqueryDefault.default(`
...
function bubbleSortGoals(arr) {
    //Outer pass
    for(let i = 0; i < arr.length; i++){
        //Inner pass
        for(let j = 0; j < arr.length - i - 1; j++)//Value comparison using ascending order
        if (getGoal(arr[j + 1]) < getGoal(arr[j])) [arr[j + 1], arr[j]] = [
            arr[j],
            arr[j + 1]
        ];
    }
...
},{}]},["44WKw","2rPnn","11gsn"], "11gsn", "parcelRequirede43")
