...
_jqueryDefault.default("html").css("background-color", "#e2e2e2");
NodeCG.waitForReplicants(subGoals, currentSubs).then(()=>_jqueryDefault.default.ready
).then(()=>{
    ...
    subGoals.on("change", (newVal)=>{
        ...
        _jqueryDefault.default(".goal-goal.inactive").remove();
        sortGoals(newVal);
    });
...
},{}]},["2rPnn","11gsn"], "11gsn", "parcelRequirede43")
