...
export default class EventSub implements TwitchModule {
  ...
  public async registerListeners() {
    ...
    if (success) {
      // Follow Events
      this.listeners.push(
        await this.eventsub.subscribeToChannelFollowEvents(this.twitch.userId, (e) => {
      ...
      // Hype Train Events
      this.listeners.push(
        await this.eventsub.subscribeToChannelHypeTrainBeginEvents(this.twitch.userId, (e) => {
          this.nodecg.log.info('Hype Train STARTED! - ', e)
        })
      )
      // Stream Ended Events
      this.listeners.push(
        await this.eventsub.subscribeToStreamOfflineEvents(this.twitch.userId, (e) => {
          this.nodecg.log.info('Jimmy Went offline :( - ', e)
        })
      )
      // Stream Started Events
      this.listeners.push(
        await this.eventsub.subscribeToStreamOnlineEvents(this.twitch.userId, (e) => {
